...
from routes import auth, my_plant, detail_my_plant, profile, plant_question, plant_updates, create_plant, consult, ai_analysis, detail_my_analysisd, analyze_plant
import uvicorn
...
app.include_router(detail_my_analysisd.router)
app.include_router(analyze_plant.router)
